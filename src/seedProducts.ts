...
export const seedCatalog: CatalogProduct[] = [
  // Aldi
  { name: "Whole Milk", brand: "Friendly Farms", storeName: "Aldi", price: 2.19, unit: "gal", normalizedUnit: "gal", size: "1 gal", priceSource: "seed" },
  { name: "Large Eggs", brand: "Goldhen", storeName: "Aldi", price: 1.89, unit: "count", normalizedUnit: "count", size: "12 ct" },
  ...
  // Walmart
  { name: "Whole Milk", brand: "Great Value", storeName: "Walmart", price: 2.48, unit: "gal", normalizedUnit: "gal", size: "1 gal" },
  { name: "Large Eggs", brand: "Great Value", storeName: "Walmart", price: 2.14, unit: "count", normalizedUnit: "count", size: "12 ct" },
  ...
  { name: "Whole Milk", brand: "Kroger", storeName: "Kroger", locationId: DEMO_KROGER_LOCATION_ID, productId: "0001111041700", upc: "0001111041700", price: 2.99, unit: "gal", normalizedUnit: "gal", size: "1 gal" },
  { name: "Large Eggs", brand: "Kroger", storeName: "Kroger", locationId: DEMO_KROGER_LOCATION_ID, productId: "0001111040101", upc: "0001111040101", price: 2.49, unit: "count", normalizedUnit: "count", size: "12 ct" },
  ...
  // Target
  { name: "Whole Milk", brand: "Good & Gather", storeName: "Target", price: 3.29, unit: "gal", normalizedUnit: "gal", size: "1 gal" },
  { name: "Large Eggs", brand: "Good & Gather", storeName: "Target", price: 2.99, unit: "count", normalizedUnit: "count", size: "12 ct" },
